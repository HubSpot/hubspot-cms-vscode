...
import { FileLink, RemoteFsDirectory } from '../../lib/types';
...
export class RemoteFsTreeDataProvider implements TreeDataProvider<FileLink> {
  ...
  getTreeItem(fileLink: FileLink): TreeItem {
    return new RemoteFsTreeDataItem(fileLink);
  }
...
export class RemoteFsTreeDataItem extends TreeItem {
